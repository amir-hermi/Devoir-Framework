			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<font color="blanc"><h2>delivery</h2></font>
						...
						<form id="contactForm">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="adresse" name="adresse" placeholder="Your adresse" required data-error="Please enter your Adresse">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" placeholder="Your Order" id="order" class="form-control" name="ordre" required data-error="Please enter your Ordre">
											<div class="help-block with-errors"></div>
										</div> 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<select class="custom-select d-block form-control" id="qte" name="qte"required data-error="Please select your Quantity">
								...
								<div class="col-md-12">
									<div class="submit-button text-center">
										<button class="btn btn-common" id="submit" type="submit">delivery now</button>
